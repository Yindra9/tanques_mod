...
const myGameArea = {
    ...
    start: function (densidadX, densidadY, cantObj_contacto, cantObj_distancia, tankPlan, basicTierSequence, spawnSettings) {
        ...
        this.eagle = null;
        this.eagleShield = [];
        this.jugador = new Tanque(10, 1, player, 0, BASE_CONFIG.playerStart.col * CELL_SIZE, BASE_CONFIG.playerStart.row * CELL_SIZE, "j", 0, [0, 1], 1, new Bala(50, 1, bullet, 0, 0, 0, 2, [0, 1], "j"));
        ...
        try {
            if (typeof window !== 'undefined' && window.localMode === 'duo' && window.player1 && window.player2) {
                ...
                this.jugador2 = new Tanque(10, 1, player, 0, sx * CELL_SIZE, sy * CELL_SIZE, 'j', 0, [0, -1], 1,
                    new Bala(50, 1, bullet, 0, 0, 0, 2, [0, 1], 'j'));
